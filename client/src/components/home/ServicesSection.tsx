...
const SERVICES = [
  {
    ...
    color: "#5b3a8e", bg: "rgba(91,58,142,0.10)", href: "/service?r=sea-and-air-customs-clearance",
  },
  {
    ...
    color: "#0a6e3f", bg: "rgba(10,110,63,0.10)", href: "/service?r=free-and-customs-bonded-warehousing",
  },
  {
    ...
    color: "#0a5b8e", bg: "rgba(10,91,142,0.10)", href: "/service?r=cross-border-clearance",
  },
  {
    ...
    color: "#b45309", bg: "rgba(180,83,9,0.10)", href: "/service?r=transport-tracking",
  },
  {
  ...
  },
  {
    ...
    color: "#0369a1", bg: "rgba(3,105,161,0.10)", href: "/service?r=sea-freight-management",
  },
];
...
export default function ServicesSection() {
  ...
  return (
    // ── Background changed from #ffffff → #f0f2f5 so white cards read clearly ──
    <section style={{ background: "#f0f2f5", padding: pad }}>
      ...
      <div style={{ textAlign: "center", marginBottom: isMobile ? "32px" : "48px" }}>
        ...
        <p style={{ fontSize: "16px", color: "#6b7280", maxWidth: "480px", margin: "0 auto", lineHeight: 1.6 }}>
          Select a service to request a quote — we respond within minutes.
        </p>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: cols, gap: isMobile ? "16px" : "20px", marginBottom: "32px" }}>
        {SERVICES.map((service, i) => (
          ...
          >
            <div style={{
              // ── Solid white background — pops cleanly against #f0f2f5 ──
              background: "#ffffff",
              // ── Default border: visible but subtle, not transparent ──
              border: hovered === i
                ? `1.5px solid ${service.color}40`
                : "1.5px solid rgba(10,22,40,0.09)",
              borderRadius: "24px",
              padding: isMobile ? "20px 16px" : "28px 24px",
              cursor: "pointer",
              transition: "all .25s ease",
              transform: hovered === i ? "translateY(-6px)" : "translateY(0)",
              // ── Default shadow: stronger than before so cards lift off the bg ──
              boxShadow: hovered === i
                ? `0 20px 48px rgba(10,22,40,0.12), 0 4px 12px ${service.color}25`
                : "0 2px 8px rgba(10,22,40,0.07), 0 1px 2px rgba(10,22,40,0.04)",
              height: "100%",
            }}>
              {/* Icon pill */}
              <div style={{
              ...
              <div style={{ marginBottom: "8px" }}>
                <div style={{ fontSize: "15px", fontWeight: 700, color: "#0a1628", marginBottom: "2px" }}>
                  {service.title}
                </div>
                <div style={{ fontSize: "11px", fontWeight: 600, color: service.color, textTransform: "uppercase", letterSpacing: "0.6px" }}>
                  {service.subtitle}
                </div>
              </div>
      ...
      <div style={{ textAlign: "center" }}>
        <a href="/services" style={{ textDecoration: "none" }}>
          <button style={{
            ...
            boxShadow: "6px 6px 16px rgba(10,22,40,0.18),-3px -3px 10px rgba(255,255,255,0.6)",
